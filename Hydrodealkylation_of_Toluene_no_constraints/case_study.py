...
initial_conditions = {
    ...
    # "ic_6": np.array([5.,         6.93754142, 2.,         2.42905978]),
    # "ic_7": np.array([3.40828738, 8.,         2.,         0.5       ]),
    # "ic_8": np.array([2.02886849, 4.49520511, 0.,         2.42897692]),
    # "ic_9": np.array([5., 8., 2., 3.]),
    # "ic_10": np.array([5.,  8.,  2.,  0.5]),
    # "ic_11": np.array([1.65742381, 8.,         0.,         2.42899872]),
    # "ic_12": np.array([5.,         8.,         0.,         2.42827699]),
    # "ic_13": np.array([5.,         5.36640217, 0.,         0.5       ]),
    # "ic_14": np.array([3.23778452, 6.80746085, 0.48906453, 2.42922085]),
    # "ic_15": np.array([5.,         3.50970958, 0.,         2.43118728]),
    # "ic_16": np.array([5.,         3.42533858, 0.,         2.4201456 ])
    }
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/graphs/Experiment_'+ str(i + 1) +'.png'
...
#             try:
#                 if j == 0:
#                     file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_T_" + str(i + 1) + ".csv") 
#                 if j == 1:
#                     file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_H_" + str(i + 1) + ".csv")
#                 if j == 2:
#                     file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_B_" + str(i + 1) + ".csv")
#                 if j == 3:
#                     file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_M_" + str(i + 1) + ".csv")
...
for i in range(num_exp):
    ...
    for j in range(num_species):
        ...
        if j == 0:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_T" + str(i + 1) + ".csv")
            name = "T_"
        if j == 1:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_H" + str(i + 1) + ".csv")
            name = "H_"
        if j == 2:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_B" + str(i + 1) + ".csv")
            name = "B_"
        if j == 3:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_M" + str(i + 1) + ".csv")
            name = "M_"
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/graphs/PI_Conc_Profile_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
for i in range(0, 5):
    ...
    file_path = 'Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/graphs/PI_Derivatives_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
#         try:
#             if i == 0:
#                 file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_T_" + str(itera + 1) + ".csv")
#                 Y = SR_derivatives_T
#                 num = 200
#             if i == 1:
#                 file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_H_" + str(itera + 1) + ".csv")
#                 Y = SR_derivatives_H
#                 num = 2000
#             if i == 2:
#                 file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_B_" + str(itera + 1) + ".csv")
#                 Y = SR_derivatives_B
#                 num = 200
#             if i == 3:
#                 file_name = str("Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_M_" + str(itera + 1) + ".csv")
#                 Y = SR_derivatives_M
#                 num = 200
...
for i in range(num_species):
    # if i == 0:
    #     path = "Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_T_" + str(itera + 1) + ".csv"
    #     name_models = "T_models"
    #     name_params = "T_params"
    
    # if i == 1:
    #     path = "Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_H_" + str(itera + 1) + ".csv"
    #     name_models = "H_models"
    #     name_params = "H_params"
    
    # if i == 2:
    #     path = "Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_B_" + str(itera + 1) + ".csv"
    #     name_models = "B_models"
    #     name_params = "B_params"
    
    # if i == 3:
    #     path = "Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/sr_data/hall_of_fame_rate_M_" + str(itera + 1) + ".csv"
    #     name_models = "M_models"
    #     name_params = "M_params"
    
    if i == 0:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_T" + str(itera + 5) + ".csv"
        name_models = "T_models"
        name_params = "T_params"
    
    if i == 1:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_H" + str(itera + 5) + ".csv"
        name_models = "H_models"
        name_params = "H_params"
    
    if i == 2:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_B" + str(itera + 5) + ".csv"
        name_models = "B_models"
        name_params = "B_params"
    
    if i == 3:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_M" + str(itera + 5) + ".csv"
        name_models = "M_models"
        name_params = "M_params"
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Hydrodealkylation_of_Toluene_no_constraints/graphs/PI_Final_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
