...
def save_matrix_as_csv(matrix, filename):
    ...
    filepath = os.path.join("Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/const_data", filename + ".csv")
...
for i in range(num_species):
    if i == 0:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_T" + str(num_exp) + ".csv"
        name_models = "T_models"
        name_params = "T_params"
    
    if i == 1:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_H" + str(num_exp) + ".csv"
        name_models = "H_models"
        name_params = "H_params"
    
    if i == 2:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_B" + str(num_exp) + ".csv"
        name_models = "B_models"
        name_params = "B_params"
    
    if i == 3:
        path = "Physics-Informed_ADoK/physics_informed_SR/Hydrodealkylation_of_Toluene/hof_files/hall_of_fame_rate_M" + str(num_exp) + ".csv"
