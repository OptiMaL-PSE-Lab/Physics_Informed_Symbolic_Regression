...
initial_conditions = {
    ...
    "ic_6": np.array([10 , 0, 0]),
    "ic_7": np.array([0.01539852, 1.51967255, 0.72669758]),
    "ic_8": np.array([0.009857,   1.52053992, 0.72855805]),
    "ic_9": np.array([10 , 0, 0]),
    "ic_10": np.array([0.02048689, 1.51901824, 0.72527931]),
    "ic_11": np.array([1.00000000e+01, 3.31097518e-03, 3.25416521e-04]),
    "ic_12": np.array([6.72168396e-08, 1.52309874e+00, 7.33975707e-01]),
    "ic_13": np.array([0.00982469, 1.5205046,  0.72832397]),
    "ic_14": np.array([10.,          0.06192279,  0.02175687]),
    "ic_15": np.array([0.01759123, 1.51773205, 0.72284383]),
    "ic_16": np.array([2.76029855, 1.82037327, 1.36884511]),
    "ic_17": np.array([10.,          1.54393408,  0.77848791]),
    "ic_18": np.array([6.64036266e-0, 1.52292602e+00, 7.33444288e-01]),
...
for i in range(num_exp):
    ...
    if i == 3:
        file_path = 'Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/Graphs/in_silico_data_experiment_4.png'
...
#             try:
#                 if j == 0:
#                     file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_NO_" + str(i + 1) + ".csv") 
#                 if j == 1:
#                     file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_N_" + str(i + 1) + ".csv")
#                 if j == 2:
#                     file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_O_" + str(i + 1) + ".csv")
...
for i in range(num_exp):
    ...
    for j in range(num_species):
        if j == 0:
            file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_NO_" \
                + str(i + 1) + ".csv")
            name = "NO_"
        if j == 1:
            file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_N_" \
                + str(i + 1) + ".csv")
            name = "N_"
        if j == 2:
            file_name = str("Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_O_" \
                + str(i + 1) + ".csv")
            name = "O_"
...
for i in range(num_exp):
    ...
    if i == 3:
        file_path = 'Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/Graphs/concentration_profile_experiment_4.png'
        plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
for i in range(0, 5):
    ...
    if i == 3:
        file_path = 'Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/Graphs/rate_estimates_experiment_4.png'
        plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
#             if i == 0:
#                 file_name = str(
#                     "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_NO_" + str(itera + 1) + ".csv"
#                     )
#                 Y = SR_derivatives_NO
#                 num = 400
#             if i == 1:
#                 file_name = str(
#                     "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_N_" + str(itera + 1) + ".csv"
#                     )
#                 Y = SR_derivatives_N
#                 num = 200
#             if i == 2:
#                 file_name = str(
#                     "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_H_" + str(itera + 1) + ".csv"
#                     )
#                 Y = SR_derivatives_O
#                 num = 200
...
#             model.fit(SR_data[:, 0].reshape(-1, 1), Y, variable_names = ["CNO"])
#             # This is a fair assumption looking at the fifth experiment
#             successful = True
#         except:
#             pass
...
for i in range(num_species):
    if i == 0:
        path = "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_NO_" + str(itera + 1) + ".csv"
        name_models = "NO_models"
        name_params = "NO_params"

    if i == 1:
        path = "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_N_" + str(itera + 1) + ".csv"
        name_models = "N_models"
        name_params = "N_params"
    
    if i == 2:
        path = "Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/sr_data/hall_of_fame_rate_H_" + str(itera + 1) + ".csv"
...
for i in range(num_exp):
    ...
    if i == 3:
        file_path = 'Physics-Informed_ADoK/Decomposition_of_Nitrous_Oxide_no_constraints/Graphs/rate_model_experiment_4.png'
        plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
