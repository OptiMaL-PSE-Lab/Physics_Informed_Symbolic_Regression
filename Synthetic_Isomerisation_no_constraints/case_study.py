...
initial_conditions = {
    ...
    # "ic_6": np.array([2., 2.]),
    # "ic_7": np.array([10., 2.]),
    # "ic_8": np.array([7.02807884, 1.17268659]),
    # "ic_9": np.array([4.46700905, 0.        ]),
    # "ic_10": np.array([4.48568949, 1.86535278]),
    # "ic_11": np.array([4.72995486, 0.95776912]),
    # "ic_12": np.array([1.00000000e+01, 2.45945813e-03]),
    # "ic_13": np.array([4.20131867, 0.        ]),
    # "ic_14": np.array([3.81350989, 0.        ]),
    # "ic_15": np.array([6.74124851e+00, 2.31025640e-04]),
    # "ic_16": np.array([4.80823024, 2.        ]),
}
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/graphs/Experiment_'+ str(i + 1) +'.png'
...
#             try:
#                 if j == 0:
#                     file_name = str("Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_A_" + str(i + 1) + ".csv") 
#                 if j == 1:
#                     file_name = str("Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_B_" + str(i + 1) + ".csv")
...
for i in range(num_exp):
    ...
    for j in range(num_species):
        # if j == 0:
        #     file_name = str("Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_A_" \
        #         + str(i + 1) + ".csv")
        #     name = "A_"
        # if j == 1:
        #     file_name = str("Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_B_" \
        #         + str(i + 1) + ".csv")
        #     name = "B_"
            
        if j == 0:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Synthetic_Isomerisation/hof_files/hall_of_fame_A" \
                + str(i + 1) + ".csv")
            name = "A_"
        if j == 1:
            file_name = str("Physics-Informed_ADoK/physics_informed_SR/Synthetic_Isomerisation/hof_files/hall_of_fame_B" \
                + str(i + 1) + ".csv")
            name = "B_"
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/graphs/PI_Conc_Profile_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/graphs/PI_Derivatives_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
...
#             if i == 0:
#                 file_name = str(
#                     "Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_rate_A_" + str(itera + 1) + ".csv"
#                     )
#                 Y = SR_derivatives_A
#                 num = 400
#             if i == 1:
#                 file_name = str(
#                     "Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_rate_B_" + str(itera + 1) + ".csv"
#                     )
#                 Y = SR_derivatives_B
#                 num = 200
...
for i in range(num_species):
    # if i == 0:
    #     path = "Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_rate_A_" + str(itera + 1) + ".csv"
    #     name_models = "A_models"
    #     name_params = "A_params"

    # if i == 1:
    #     path = "Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/sr_data/hall_of_fame_rate_B_" + str(itera + 1) + ".csv"
    #     name_models = "B_models"
    #     name_params = "B_params"
        
    if i == 0:
        path = "Physics-Informed_ADoK/physics_informed_SR/Synthetic_Isomerisation/hof_files/hall_of_fame_rate_A" + str(itera + 5) + ".csv"
        name_models = "A_models"
        name_params = "A_params"

    if i == 1:
        path = "Physics-Informed_ADoK/physics_informed_SR/Synthetic_Isomerisation/hof_files/hall_of_fame_rate_B" + str(itera + 5) + ".csv"
        name_models = "B_models"
        name_params = "B_params"
...
for i in range(num_exp):
    ...
    file_path = 'Physics-Informed_ADoK/Synthetic_Isomerisation_no_constraints/graphs/PI_Final_'+ str(i + 1) +'.png'
    plt.savefig(file_path, dpi = 600, bbox_inches = "tight")
